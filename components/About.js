...
const bio = [
  {
    id: 11,
    data: [
      { id: 1, type: "First Name", value: "Selena" },
      { id: 2, type: "Last Name", value: "Siri" },
      // { id: 3, type: "Age", value: "27 Years" },
      { id: 4, type: "Nationality", value: "USA" },
  ...
  },
  {
    id: 12,
    data: [
      { id: 6, type: "Address", value: "New York" },
      // { id: 7, type: "Phone", value: "848 342 9868" },
      { id: 8, type: "Email", value: "sitesbysiri.com" },
      { id: 9, type: "Skype", value: "selenasiri" },
      { id: 10, type: "Langages", value: "English, Mandarin, French, Spanish" },
    ],
  },
];
...
const counters = [
  ...
  { id: 4, title: 'countries <span className="block">visited</span>', value: "8" },
];
...
const experiences = [
  {
    ...
    company: "gaze",
    desc: "Planned and executed frontend pages to capture the company's mission: to provide an engaging & trustworthy online shopping experience. Collaborated with the UX/UI design teams to bring the startup's design to life for desktop and mobile versions of the application - Figma, Flutter, React/redux, TypeScript, Node.js",
  },
  {
    id: 2,
    date: "03/23 - 06/23",
    ...
    company: "ernst & young",
    desc: "Directly handled Pandas automation tools for a new data-cleaning application. Repopulated monthly spreadsheets of 3,000+ employees in an internal management dashboard in under 2 seconds, reducing manual labor by 99.99% - Django REST Framework, Python, Pandas, PostgreSQL, Docker, Kubernetes",
  },
  {
    id: 3,
    date: "06/21 - 08/22",
    title: "digital assets",
    company: "junior web engineer",
    desc: "Built and deployed a backend service to collect live stock data from Polygon and TwelveData APIs. Collaborated with the engineering team on new functionalities to retrieve fast, accurate data for stock-based financial services - Python, Django, APIs (Interactive Brokers, Polygon, TwelveData)",
  },
];
...
const educations = [
  {
    ...
    unv: "Rutgers University",
    desc: "Deans List, 2016",
  },
  {
    id: 2,
    date: "2019",
...
const skills = [
  { id: 1, name: "react", value: "92" },
  { id: 2, name: "javascript", value: "89" },
  { id: 3, name: "css", value: "60" },
  { id: 4, name: "vue", value: "56" },
  { id: 5, name: "django", value: "88" },
  { id: 6, name: "html", value: "90" },
  { id: 7, name: "python", value: "71" },
  { id: 8, name: "pandas", value: "55" },
];
          ...
          <div className="flex flex-row down-lg:flex-col">
            ...
            <div className="xl:basis-1/2 lg:basis-5/12 down-lg:basis-full">
              ...
              <a
                ...
                href="assets/Selena_Siri_Full_Stack_Engineer_Resume_2024.pdf"
              >
                <span
