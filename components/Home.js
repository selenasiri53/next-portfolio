    ...
    <SectionContainer id="home">
      ...
      <div className="flex items-center h-screen w-full down-lg:mx-auto down-lg:justify-center xs:text-left down-lg:text-center ">
        ...
        <img
          ...
          src={authorImage ? authorImage : "assets/img/selena_siri_headshot.jpg"}
          alt=""
        />
        {/* Desktop Image Ends */}
        <div className="from-lg:ml-100/3 from-lg:w-2/3">
          <div className="mx-auto max-w-550 custom-md-1:max-w-450">
            ...
            <img
              ...
              src="assets/img/selena_siri_headshot.jpg"
            ...
            <p className="font-Open-sans mt-15 mb-28 leading-lh-35 down-lg:mt-2.5 down-lg:mb-23 down-lg:text-fs-15 down-lg:leading-lh-30">
              I'm a New York based web developer inspired by engaging, modern sites 
              using Next.js, TypeScript & React. I'm passionate about creating engaging UX/UI experiences 
              and making a positive difference for those around me. 
            </p>
            <div
              id="link-about"
